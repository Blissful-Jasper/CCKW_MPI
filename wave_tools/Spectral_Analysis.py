...
from  wave_tools.utils import save_figure
...
class SpectralAnalysis:
    ...
    def plot_spectra(self,filename=None, output_path=None):
        """
        ...
        for ax in axes: 
            ...
            ax.set_ylim([0,0.5])
        plt.show()
        save_figure(fig,filename,output_path)
    def save_spectra(self, output_path="./spectra_output/spectra_combined.nc"):
        """
        Save symmetric power, antisymmetric power, and background spectrum 
        (after smoothing if applied) into a single NetCDF file.
        ...
        print(f"Saving all spectra to {output_path}...")
